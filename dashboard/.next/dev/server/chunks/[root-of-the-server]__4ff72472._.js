...
"[project]/dashboard/app/api/dashboard/stats/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        const [totalPosts, topicsCountLast24h, alertCount, recentPostCount] = await Promise.all([
        ...
        const [rumorPosts, toxicPosts, anomalyCount, topicCount, entityCount, summaryCount] = await Promise.all([
            db.collection("rumor").countDocuments({
                rumor_score: {
                    $gt: 0.5
                }
            }),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4ff72472._.js.map